    ...
    public function status_seguimiento($array, $object)
    {
        ...
        foreach ($array as $data) {
            if ($object == 'status') {
                switch ($data->status) {
                    case 'Revisada':
                        $status_array[] = ['status' => 'Revisado'];
                        break;
                    case 'Aprobada':
                        $status_array[] = ['status' => 'Aprobado'];
                        break;
                    case 'Rechazada':
                ...
                switch ($data->status) {
                    case 'Revisada':
                        $status_array[] = ['icon' => 'fas fa-envelope-open-text mx-3'];
                        break;
                    case 'Aprobada':
                        $status_array[] = ['icon' => 'fas fa-clipboard-check mx-3'];
                        break;
                    case 'Rechazada':
                        $status_array[] = ['icon' => 'fas fa-file-excel mx-4'];
                        break;
                    case 'Transito':
