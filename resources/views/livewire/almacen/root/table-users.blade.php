...
<table class="table bg-white border shadow-sm rounded-2">
    ...
    <!-- <tr>
      <td ><span class="text-center text-gray">No hay registros</span> </td>
        ...
        <tr class="">
          <th class="pt-3 font-weight-normal text-decoration-underline text-center">1</th>
          <th class="pt-3 font-weight-normal text-center">231VI293</th>
          <th class="pt-3 font-weight-normal text-center">Jose ALberto Hernandez Leyva</th>
          <th class="pt-3 font-weight-normal ">Virología</th>
          <th class="pt-3 font-weight-normal ">jose@gmail.com</th>
          ...
          <button  type="button" class="pt-2" >
            ...
            <button   type="button" class="pt-2 mx-3">
