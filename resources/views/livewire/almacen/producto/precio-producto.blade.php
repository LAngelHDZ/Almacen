 <div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title h3" id="exampleModalLabel">Precios y proveedores</h5>
            ...
            <div class="modal-footer">
              <button type="button" class="px-4 py-2 rounded-md bg-gray hover:border-black" data-dismiss="modal">Cerrar</button>
    ...
    <button wire:click.prevent='show' type="button" class="pt-2 btn btn-outline-success" >
                ...
                @foreach($listPrecio as $data)
                    <tr class="">
                        ...
                        <td class="text-center">
                            <button wire:click.prevent='' type="button" class="pt-2" >
                            ...
                            <button wire:click.prevent='update({{$data->idprecio}})'  type="button" class="pt-2 mx-3">
