        ...
        <div class="inline-flex py-1 mr-5 bg-white rounded-sm ">
            <div>
                ...
                <nav class="w-full text-white bg-indigo-500">
                    ...
                    <a @click="showefirma(efirma)" class="block px-2 py-2 text-center  text-white  border-bottom hover:bg-indigo-600">eFirma</a>
                ...
                <div class="flex w-full py-3 bg-white rounded-sm ">
                  @foreach ($info as $data)
                    ...
                    <div class="px-5 py-1 mt-2">
                      ...
                      <label class="block mt-2 mb-0 text-bold" for="">Departamento</label>
                      <p>{{ $data->departamento }}</p>
                      <label class="block mt-2 mb-0 text-bold" for="">Area</label>
                      <p>{{ $data->area }}</p>
                  ...
                  @endforeach
                    ...
                    class="w-2/3">
                        ...
                        <div class="px-5 py-1 mt-2">
                            ...
                            <input type="text" class="form-input rounded-sm hover:border-blue-700 w-75">
                    ...
                    class="w-2/3 ">
                        ...
                        <div class="px-5 py-1 mt-2">
                            ...
                            <p>iyuh5825N28SHf5JiuhgdLKiGr58hfjuo5</p>
